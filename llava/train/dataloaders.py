...
def preprocess_v1(
    ...
    # USER: <image>\nWhat is the approximate tempo of the clip in beats per minute
    # (BPM)? ASSISTANT: The tempo of the clip is approximately 127.7 beats per
    # minute.</s>"]
    # vicunna
    # ["A chat between a curious user and an artificial intelligence assistant. The
    # assistant gives helpful, detailed, and polite answers to the user's questions.
...
class AudioLazySupervisedDataset(LazySupervisedDataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        # For now, using AudiosetSL
        # {
        # "instruction": "What is the significance of the sound of crying in this audio clip?",
        # "input": "",
        # "audio_id": "/data/sls/audioset/dave_version/audio/LZq4Neh-oWU.flac",
        # "dataset": "as_strong_train",
        # "task": "open-ended question",
        # "output": "The sound of crying suggests that there is a sad or emotional situation happening in the audio clip.",
        # "local_audio_id": "LZq4Neh-oWU.flac",
        # "wavcaps_caption": "Music plays while a horse is ridden and a dog barks, while a person cries with the sound of crickets in the background.",
        # "local_audio_path": "YLZq4Neh-oWU.flac"
        # },
        sources = self.list_data_dict[i]
        # stage1 aligns the connector to the image modality,
        # by (1) inject psudo captions; (2) make it a list
        # NOTE: for stage1 training, from_human is not used
